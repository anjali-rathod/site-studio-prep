...
/* sites/default/files/cohesion/templates/menu--cohesion-menu-tpl-utilities-menu.html.twig */
class __TwigTemplate_036bc49b6dafdf239da73d851ed50229 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function __construct(Environment $env)
    {
        ...
        $this->blocks = [
            'block1112437120' => [$this, 'block_block1112437120'],
        ];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo " ";
        $this->displayBlock('block1112437120', $context, $blocks);
        echo " 
";
    }

    public function block_block1112437120($context, array $blocks = [])
    {
        $macros = $this->macros;
        echo " ";
        if (( !twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "below", [], "any", true, true, true, 1) || (twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "below", [], "any", true, true, true, 1) && (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "below", [], "any", false, false, true, 1)) > 0)))) {
            echo " <ul class=\"coh-menu-list-container coh-unordered-list coh-ce-9c23e4ec\">";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                ...
                if ((($context["i"] <= twig_length_filter($this->env, ($context["items"] ?? null))) && ($context["inRange"] ?? null))) {
                    ...
                    if (twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "below", [], "any", true, true, true, 1)) {
                        ...
                        echo " data-coh-settings='{ \"xl\":{\"link_interaction\":\"toggle-on-hover\",\"animationType\":\"none\"} }' class=\"coh-link coh-ce-4be69de6 js-coh-menu-item-link";
    ...
    {
        return "sites/default/files/cohesion/templates/menu--cohesion-menu-tpl-utilities-menu.html.twig";
    }
    ...
    {
        return new Source("", "sites/default/files/cohesion/templates/menu--cohesion-menu-tpl-utilities-menu.html.twig", "/var/www/html/web/sites/default/files/cohesion/templates/menu--cohesion-menu-tpl-utilities-menu.html.twig");
    }
