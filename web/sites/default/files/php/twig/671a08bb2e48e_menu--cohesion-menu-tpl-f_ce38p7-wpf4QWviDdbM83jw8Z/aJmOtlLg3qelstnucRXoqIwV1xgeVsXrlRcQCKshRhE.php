...
class __TwigTemplate_c1544a49d04f6336b08c37b35324e4bd extends Template
{
    private $source;
    private $macros = [];
    ...
    public function __construct(Environment $env)
    {
        ...
        $this->blocks = [
            'block1930270006' => [$this, 'block_block1930270006'],
        ];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo " ";
        $this->displayBlock('block1930270006', $context, $blocks);
        echo " 
";
    }

    public function block_block1930270006($context, array $blocks = [])
    {
        $macros = $this->macros;
        echo " ";
        if (( !twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "below", [], "any", true, true, true, 1) || (twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "below", [], "any", true, true, true, 1) && (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "below", [], "any", false, false, true, 1)) > 0)))) {
            echo " <ul class=\"coh-menu-list-container coh-unordered-list coh-ce-c2e6bd89\">";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                ...
                if ((($context["i"] <= twig_length_filter($this->env, ($context["items"] ?? null))) && ($context["inRange"] ?? null))) {
                    ...
                    echo "<li class=\"coh-menu-list-item coh-ce-c2a716e9 js-coh-menu-item";
                    ...
                    if (twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "below", [], "any", true, true, true, 1)) {
                        ...
                        echo " data-coh-settings='{ \"xl\":{\"link_interaction\":\"click-through-to-link\"} }' class=\"coh-link coh-ce-3d39c93a js-coh-menu-item-link";
