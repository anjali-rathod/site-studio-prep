...
/* __string_template__56c9437c89c2bff0793a4161dc1cd9fd */
class __TwigTemplate_0493a3ee474f0f6e758f618af00f296d extends Template
{
    private $source;
    private $macros = [];
    ...
    public function __construct(Environment $env)
    {
        ...
        $this->blocks = [
            'block1619242394' => [$this, 'block_block1619242394'],
            'block4157783518' => [$this, 'block_block4157783518'],
            'block3935146932' => [$this, 'block_block3935146932'],
        ];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block1619242394', $context, $blocks);
        echo " ";
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block4157783518', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
        ...
        echo " ";
        $context["component_variable_50537163_ed2d_4ae2_bdb5_e3184c473279"] = ('' === $tmp = "coh-style-read-more") ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        ...
        ob_start(function () { return ''; });
        echo " ";
        $this->displayBlock('block3935146932', $context, $blocks);
        echo " ";
        $context["dropZoneContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " ";
        if ( !array_key_exists("dropZones", $context)) {
...
";
    ...
    public function block_block1619242394($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block4157783518($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    public function block_block3935146932($context, array $blocks = [])
    {
        $macros = $this->macros;
    ...
    {
        return "__string_template__56c9437c89c2bff0793a4161dc1cd9fd";
    }
    ...
    {
        return new Source("", "__string_template__56c9437c89c2bff0793a4161dc1cd9fd", "");
    }
