...
/* __string_template__26b9167a0f223d23f0a17e66b4723ec7 */
class __TwigTemplate_e924649323082a72ba47138526b37223 extends Template
{
    private $source;
    private $macros = [];
...
.coh-ce-cpt_feature_cards-901c113b {
  max-width: 40%;
  margin-top: auto;
  margin-right: auto;
  margin-bottom: auto;
...
.coh-ce-cpt_promoted_card-a56dd7b {
  display: -webkit-box;
  display: -webkit-flex;
  display: -ms-flexbox;
  display: flex;
...
.coh-ce-cpt_promoted_card-8f0a643d {
  width: 50%;
  position: relative;
}
.coh-ce-cpt_promoted_card-9fca2efc {
  position: absolute;
  top: 30%;
  right: 0;
  z-index: 1;
...
.coh-ce-cpt_promoted_card-ec38f0c9:after {
  content: ' ' ;
  width: 30%;
  border: 3px solid white;
  display: block;
}
.coh-ce-cpt_promoted_card-62c1dfbe {
...
.coh-ce-cpt_promoted_card-62c1dfbe:active {
  content: ' ';
  border: 3px solid white;
  display: block;
  width: 30%;
...
.coh-ce-cpt_stretch_card-5170c261 {
  display: -webkit-box;
  display: -webkit-flex;
  display: -ms-flexbox;
  display: flex;
...
.coh-ce-cpt_stretch_card-57a5022d {
  padding-top: 50px;
  padding-right: 50px;
  padding-bottom: 50px;
  padding-left: 50px;
...
.coh-ce-cpt_stretch_card-f9c1fe90:after {
  content: ' ';
  width: 30%;
  border-bottom: 3px solid orange;
  display: block;
}
.coh-ce-cpt_stretch_card-2be6e5b2 {
  display: -webkit-box;
  display: -webkit-flex;
  display: -ms-flexbox;
  display: flex;
...
.coh-ce-cpt_stretch_card-d672a3e3 {
  display: block;
  width: 40%;
}
.coh-ce-cpt_stretch_card-5264e36f {
  width: 30%;
}
...
";
    ...
    {
        return "__string_template__26b9167a0f223d23f0a17e66b4723ec7";
    }
    ...
    {
        return new Source("", "__string_template__26b9167a0f223d23f0a17e66b4723ec7", "");
    }
