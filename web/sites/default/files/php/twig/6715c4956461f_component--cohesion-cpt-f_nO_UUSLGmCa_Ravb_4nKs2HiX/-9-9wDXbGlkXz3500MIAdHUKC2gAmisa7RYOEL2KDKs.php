...
class __TwigTemplate_ebc93a110496c8628da94d20b44c7991 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo " coh-ce-cpt_feature_cards-79652c93\" > ";
        ...
        echo " <a href=\"";
        ob_start(function () { return ''; });
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\cohesion_templates\TwigExtension\TwigExtension']->getComponentFieldValue($context, "f3eedc72-2c92-4c6c-8b5a-ba3f327d11c1"));
        ...
        echo "\" class=\"coh-link coh-style-focusable-content\" target=\"_self\" > </a> ";
        ...
        echo " <img class=\"coh-image coh-image-xl coh-image-align-centre-xl\" src=\"";
        ob_start(function () { return ''; });
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\cohesion_templates\TwigExtension\TwigExtension']->getComponentFieldValue($context, "3e80ad0e-693d-408d-9c66-e608820a5e5a"));
        ...
        echo "\" /> ";
        ob_start(function () { return ''; });
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\cohesion_templates\TwigExtension\TwigExtension']->getComponentFieldValue($context, "7a4ec4e3-0cf0-40dd-bc31-cd21d6304f63"));
        $context["paragraphContent"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo " <p class=\"coh-paragraph coh-ce-cpt_feature_cards-ea4928af\" ";
        if ((twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "hasPermission", [0 => "access visual page builder"], "method", false, false, true, 1) &&  !array_key_exists("component_content", $context))) {
            ...
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\cohesion_templates\TwigExtension\TwigExtension']->renderFieldUuid($context, "7a4ec4e3-0cf0-40dd-bc31-cd21d6304f63", "Array"), "html", null, true);
...
";
        ...
        ob_start(function () { return ''; });
        echo "<style>";
        if ( !twig_test_empty($this->extensions['Drupal\cohesion_templates\TwigExtension\TwigExtension']->getComponentFieldValue($context, "de5f0a07-1631-4208-b957-280881cd41ea"))) {
            echo ".";
...
";
            ...
            if ( !twig_test_empty($this->extensions['Drupal\cohesion_templates\TwigExtension\TwigExtension']->getComponentFieldValue($context, "de5f0a07-1631-4208-b957-280881cd41ea"))) {
                ...
                if ( !twig_test_empty($this->extensions['Drupal\cohesion_templates\TwigExtension\TwigExtension']->getComponentFieldValue($context, "de5f0a07-1631-4208-b957-280881cd41ea"))) {
                    ...
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\cohesion_templates\TwigExtension\TwigExtension']->getComponentFieldValue($context, "de5f0a07-1631-4208-b957-280881cd41ea"));
                    echo ";";
                }
            }
            // line 4
    ...
    {
        return array (  117 => 5,  114 => 4,  105 => 3,  97 => 2,  39 => 1,);
    }
    ...
    public function checkSecurity()
    {
        ...
        static $functions = array("coh_instanceid" => 1, "attach_library" => 1, "getComponentFieldValue" => 1, "path_renderer" => 1, "cohesion_image_style" => 1, "render_field_uuid" => 1, "renderInlineStyle" => 5);

        try {
            $this->sandbox->checkSecurity(
                ['set', 'if'],
                ['escape', 'raw', 'nl2br'],
                ['coh_instanceid', 'attach_library', 'getComponentFieldValue', 'path_renderer', 'cohesion_image_style', 'render_field_uuid', 'renderInlineStyle']
            );
