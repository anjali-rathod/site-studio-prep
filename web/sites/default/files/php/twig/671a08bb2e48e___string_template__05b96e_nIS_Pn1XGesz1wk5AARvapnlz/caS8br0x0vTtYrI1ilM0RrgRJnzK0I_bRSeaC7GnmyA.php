...
/* __string_template__05b96e45c159ec08654d259999193859 */
class __TwigTemplate_75a573e8254eba9f40f3808f441a472d extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 2
        echo ".ssa-ck-content :root {
  --ssa-color-palette-black: rgb(0, 0, 0);
  --ssa-color-palette-blue: rgb(39, 60, 149);
  ...
  --ssa-color-palette-green: rgb(130, 241, 175);
  --ssa-color-palette-maroon: rgb(142, 61, 61);
  --ssa-color-palette-off-green: rgb(230, 240, 231);
  --ssa-color-palette-off-orange: rgb(255, 209, 156);
  --ssa-color-palette-orange: rgb(252, 151, 67);
...
.ssa-ck-content .coh-color-maroon {
  color: rgb(142, 61, 61);
}
...
.ssa-ck-content :root {
  ...
  --ssa-responsive-grid-settings-boxed-width: 84rem;
  --ssa-responsive-grid-settings-inner-gutter: 2rem;
  --ssa-responsive-grid-settings-outer-gutter: 8rem;
}
...
.ssa-ck-content .coh-style-flex-direction {
  -webkit-box-orient: horizontal;
  -webkit-box-direction: normal;
  -webkit-flex-direction: row;
      -ms-flex-direction: row;
...
.ssa-ck-content .coh-style-flex-left-to-right {
  -webkit-box-orient: horizontal;
  -webkit-box-direction: normal;
  -webkit-flex-direction: row;
      -ms-flex-direction: row;
...
.ssa-ck-content .coh-style-flex-right-to-left {
  -webkit-box-orient: horizontal;
...
";
    ...
    {
        return "__string_template__05b96e45c159ec08654d259999193859";
    }
    ...
    {
        return new Source("", "__string_template__05b96e45c159ec08654d259999193859", "");
    }
